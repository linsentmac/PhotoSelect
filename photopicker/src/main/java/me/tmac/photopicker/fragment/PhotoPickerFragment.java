...
import me.tmac.photopicker.PhotoCamDisplayActivity;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == ImageCaptureManager.REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            if (directories.size() > 0) {
                ...
                Intent intent = new Intent(getActivity(), PhotoCamDisplayActivity.class);
                intent.putExtra("display_path", path);
                startActivityForResult(intent, PhotoCamDisplayActivity.DISPLAY_PHOTO);
                //getActivity().finish();
            }
        } else if (requestCode == PhotoCamDisplayActivity.DISPLAY_PHOTO && resultCode == RESULT_OK) {
            String callback_path = data.getStringExtra("callback_path");
            Intent intent = new Intent();
            intent.putExtra("callback_path", callback_path);
